...
<style>
    ...
    <ul class="menu">
        ...
        <button type="button" class="przycisk"  id="click" runat="server" ><a href="https://www.facebook.com"><img class="obrazek" src="ih.png"></img></a></button> 
         <button type="button" id="Button4" onclick="sss" runat="server"><img src="ih.png"/></button> <%--jedno klikniecie zmeinia tekst--%>
